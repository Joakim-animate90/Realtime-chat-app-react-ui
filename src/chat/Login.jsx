    ...
    render() {
        ...
        return (
            <div>
                ...
                <Drawer width='500px' forceRender={true} title="register" placement="right" onClose={this.registerDrawerOnClose} visible={this.state.registerDrawerVisible}>
                    <Form
                        name="basic"
                        labelCol={{ span: 4 }}
                        wrapperCol={{ span: 16 }}
                    ...
                    >
                        ...
                        <Form.Item
                            label="Mail"
                            name="email"
                            rules={[{ required: true, message: 'Mail!' }]}
                        >
                            <Input />
                        </Form.Item>
                        ...
                        <Form.Item
                            label="Nick name"
                            name="nickname"
                            rules={[{ required: true, message: 'Nick name!' }]}
                        >
                            <Input />
                        </Form.Item>
